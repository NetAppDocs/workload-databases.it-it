...
* *Credenziali e permessi*: Devi avere link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html["Credenziali dell'account AWS e autorizzazioni di visualizzazione, pianificazione e analisi"^] per creare un clone sandbox in Workload Factory.
+
