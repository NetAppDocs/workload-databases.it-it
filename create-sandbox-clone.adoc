...
* *Credenziali e autorizzazioni*: Devi avere link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html["Credenziali dell'account AWS e autorizzazioni per _operations and remediation_"^] per creare un clone sandbox in Workload Factory.
+
