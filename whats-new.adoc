...
link:https://docs.netapp.com/us-en/workload-databases/register-instance.html["Registra le risorse in Workload Factory for Databases"]
...
=== Analisi dei costi e pianificazione della migrazione degli ambienti di database locali di SQL Server

BlueXP Workload Factory for Databases ora rileva, analizza e ti aiuta a pianificare la migrazione del database SQL Server on-premises ad Amazon FSx for NetApp ONTAP. Puoi utilizzare il calcolatore di risparmio per stimare il costo di esecuzione del tuo ambiente di database SQL Server on-premises nel cloud e consultare le raccomandazioni per la migrazione del tuo ambiente di database on-premises al cloud.
