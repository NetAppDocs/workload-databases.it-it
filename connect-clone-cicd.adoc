...
summary: 'Collega un clone sandbox a una pipeline CI e CD tramite codice API REST per migliorare la distribuzione del software attraverso l"automazione.' 
---
= Connetti un clone sandbox a CI/CD in NetApp Workload Factory per database
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
