...
La distribuzione di Microsoft SQL Server in una rete privata senza connettività in uscita mediante Terraform è supportata solo nell'area geografica US-East-1 (N. Virginia). PostgreSQL non supporta Amazon CloudWatch o la distribuzione in una rete privata.
